 ...
 * Describe  自定义的下载 使picasso使用okhttp加载图片
 * http://blog.csdn.net/lvshaorong/article/details/52180610
 *
 */
  public final class OkHttp3Downloader implements Downloader {
    private static final String PICASSO_CACHE = "picasso-cache";//图片缓存文件名
